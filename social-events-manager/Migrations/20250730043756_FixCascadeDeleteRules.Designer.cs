...
namespace social_events_manager.Migrations
{
    ...
    [Migration("20250730043756_FixCascadeDeleteRules")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("social_events_manager.Modules.Attendees.Models.Attendee", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("social_events_manager.Modules.Auth.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("social_events_manager.Modules.Auth.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("social_events_manager.Modules.Attendees.Models.Attendee", b =>
                {
                    b.HasOne("social_events_manager.Modules.Auth.Models.AppUser", "AppUser")
                        .WithMany("Attendees")
            ...
            modelBuilder.Entity("social_events_manager.Modules.SocialEvents.Models.SocialEvent", b =>
                {
                    ...
                    b.HasOne("social_events_manager.Modules.Locations.Models.Location", "Location")
                        .WithMany("SocialEvents")
